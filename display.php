  ...
  $("#footer-section").load("footer.html")
	...
	<div class="main-content" style="margin-top:-370px; background:#fff; width:80%; position:relative; left:50%; transform:translate(-50%); box-shadow:4px 8px 16px rgba(0,0,0,.4); border-radius:10px;">
		<div class="container">
			...
			<br />
			<br />
			<h2 align="center" style="font-family:'Garamond','Times New Roman'"> Issue Details of IT </h2><br />
			<div class="form-group">
				<div class="input-group" style='width:100%'>
					<input type="text" name="search_text" id="search_text" placeholder="Search by Group ID  / Component Name" class="form-control" />
				</div>
			</div>
			<br />
			<div id="result"></div>
